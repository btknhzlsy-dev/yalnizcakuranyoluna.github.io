...
const ayetVerisi = { 
    ...
    "2": { // Sure No: 2 (Bakara)
            ...
            "2": {
                ...
                "anaCeviri": "Şu  kitap,  içesinde (ne varsa) hiç şüphe yoktur,  müttakiler için  yol göstericidir.",
                "kelimeler": [
                    {
                        "id": 1,
                        "arapca": "ذَٰلِكَ",
                ...
                "ceviriler": [
                    {
                        "yazar": "ŞG",
                        "metin": "İçerisinde kuşku verici, tutarsızlık, kopukluk olmayan; vahyin sınırlarına uyup korunanlar için bir yol gösterici olan işte bu kitaptır."
                    },
                    {
                        "yazar": "İEr",
                        "metin": "İşte bu; kitaptır; yoktur şüphe onda; bir doğru yola kılavuzdur takva sahipleri için.İ.E"
                    },
                    {
                        "yazar": "ZH",
                        "metin": "Şu  kitap,  içesinde (ne varsa) hiç şüphe yoktur,  müttakiler için  yol göstericidir"
                    }
                ]
            }
    }    
